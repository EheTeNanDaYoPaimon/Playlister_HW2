    ...
    render() {
        ...
        return (
            ...
            <input 
                ...
                disabled={canAddSong ? false : true}//fool proof
            />
            <input 
                type="button" 
                id='undo-button' 
                ...
                disabled={canUndo ? false : true}//fool proof
            />
            <input 
                type="button" 
                id='redo-button' 
                ...
                disabled={canRedo ? false : true}//fool proof
            />
            <input 
                type="button" 
                id='close-button' 
                ...
                disabled={canClose ? false : true}//fool proof
            />
        </div>
        )
    }
